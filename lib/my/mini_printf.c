...
static int format_integer(int i, char const *format, va_list list, int count)
{
    if (format[i + 1] == 'd')
...
static int format_string(int i, char const *format, va_list list, int count)
{
    if (format[i + 1] == 's')
...
static int format_modulo(int i, char const *format, va_list list, int count)
{
    if (format[i + 1] == '%'){
        my_putchar('%');
        count++;
